...
var instrucciones = ["Usar la flechas para mover las fichas y armar el rompecabezas",
                    "Moviendo hacia arriba, la ficha superior al espacio vacio ocupara ahora ese espacio",
                    "Lo mismo sucede con los demás movimientos"];
...
//Para contar en cuantos movimientos gano, sin tener en cuenta los movimientos hechos para mezclar
var jugando = false;
...
function mostrarInstrucciones(instrucciones) {
  ...
  for (var n=0;n<instrucciones.length;n++){
    mostrarInstruccionEnLista(instrucciones[n],"lista-instrucciones")
  }
...
function mostrarCartelGanador() {
  ...
  if (chequearSiGano()){
    alert("Ganaste en " + movimientos.length + " movimientos!");
  }
...
function moverEnDireccion(direccion) {
  ...
  if (posicionValida(nuevaFilaPiezaVacia, nuevaColumnaPiezaVacia)) {
      ...
      //Agrega la dirección del movimiento al arreglo de movimientos (solo cuando esta jugando y no mezclando)
      if (jugando){
